...
pub fn unpack_gz(binary: Vec<u8>, source_stem: String, disk_root: String) -> Vec<ArchiveEntry> {
...
pub fn unpack_tar(binary: Vec<u8>, _source_stem: String, disk_root: String) -> Vec<ArchiveEntry> {
    let mut entries = vec![];
    let disk_root: PathBuf = disk_root.into();
...
mod unit_test {
    ...
    #[test]
    fn unpack_gz_test() {
        let binary = fs::read(r"C:\Users\20366\Desktop\misc\tar-rs-0.4.40.tar.gz").unwrap();
        let entries = unpack_gz(binary, "tar-rs-0.4.40.tar".to_string(), r"C:\Users\20366\Desktop\misc\unpack_gz".into());
    ...
    fn unpack_tar_test() {
        ...
        let entries = unpack_tar(binary, "".to_string(), r"C:\Users\20366\Desktop\misc\unpack_tar".into());
    ...
    fn unpack_tgz_test() {
        ...
        let entries = unpack_tar(binary, "".to_string(), r"C:\Users\20366\Desktop\misc\unpack_tgz".into());
